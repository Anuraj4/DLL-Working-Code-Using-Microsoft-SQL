...
using EOB_TO_EDI_835.AvaloniaUI.Views;

namespace EOB_TO_EDI_835.AvaloniaUI;
...
public partial class App : Application
{
    public override void Initialize()
    {
        ...
        {
            System.IO.File.WriteAllText("xaml_init_error.txt", ex.ToString());
            throw;
        }
    }
